...
# запущены на круговые орбиты. Результатом функции должен быть кортеж, содержащий длины полуосей эллипса орбиты
...
# lists = [1, 2], [5, 6], [5, 5], [2, 9]
# print(list)
elips_orbit = [(random.randint(1, 10), random.randint(1, 10)) for _ in range(10)]
print(elips_orbit)

elips_orbit = list(filter(lambda x: x[0] != [1], elips_orbit))
print(elips_orbit)

elips_orbit = list(map(lambda x: int(x[0] * x[1] * math.pi), elips_orbit))
print(elips_orbit)
print(max(elips_orbit))
