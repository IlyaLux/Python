# 1. Уставшие от необычно теплой зимы, жители решили узнать, действительно ли это самая длинная оттепель за всю
...
day = int(input("введите кол-во рассматриваемых дней: "))
temp = randint(-3, 3)
count = 0
count_day = 0
warm_days = 0
